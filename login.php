    ...
    <script src="https://cdnjs.cloudflare.com/ajax/libs/bootstrap-select/1.13.1/js/bootstrap-select.min.js"></script>
      ...
      <div class="loginbox">
          ...
          <form action="login_process.php"method="POST" >
              ...
              <p>User name</p>
              <input type="text" id="user" name="user" placeholder="Enter Username"	required="required" autocomplete="off"/>
  
              <p>Password</p>
              <input type="Password" id="password" name="password" placeholder="Enter Password"	required="required" autocomplete="off" /> 

              <input type="submit" id="btn" name="submit" value="Login"><br> <a href="#"><font style="color: #1588ff">Reset Your Password</font></a><br>
  
              <p class="message">
                  Not Registered? <a href="#"><font style="color: #1588ff;">Register</font></a>
              </p>
              <br>
